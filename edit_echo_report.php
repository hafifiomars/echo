...
<div class="column" style="background-color:white;">
    ...
    <div class="container p-3 my-3 bg-dark text-white">
	 ...
	 <input type="radio" id="shunt4" name="shunt" value="noshunt" onclick="funshunt()"/><label> No Shunt</label><br>
      ...
      <label for="txteditreport">Comment: </label>
      <input type="text" class="form-control" name="txteditreport" id="txteditreport" value="<?php echo $row_rececho['reason']; ?>" /><br>
  ...
  <form id="form1" name="form1" method="post" onsubmit="return validate(this)" action="edit_echo_report_exec.php?er=3" >
  <div>
    <h3 align="center"> ECHOCARDIOGRAM REPORT</h3>
  </div>
...
<div class="column" style="background-color:white;">
    ...
    <div class="container p-3 my-3 bg-dark text-white">
	 ...
	 <input type="radio" id="shunt4" name="shunt" value="noshunt"<?php echo ( $row_rececho4['Shunt'] == 'noshunt') ? 'checked' : ''; ?>  onclick="funshunt()"/> No Shunt</label><br>
      ...
      <label for="txteditreport">Comment: </label>
      <input type="text" class="form-control" name="txteditreport" id="txteditreport" size="250" value="<?php echo $row_rececho['reason']; ?>" /><br>
      
      <label for="dateupdated">Last Updated</label>
      <input type="text" class="form-control" name="dateupdated" id="dateupdated" value="<?php echo $row_rececho4['updatedttm']; ?>" readonly /><br>
