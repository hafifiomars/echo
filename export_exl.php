...
<script type="text/javascript">
  ...
  function showUser2(str2) //search based on Status Tempahan
  {
      if (str2 == "") {
          document.getElementById("txtHint").innerHTML = "";
          return;
  ...
  function showUser3(str2) //search based on patient type
  {
      if (str2 == "") {
          document.getElementById("txtHint").innerHTML = "";
          return;
...
<td><?php echo $row_recpatreviewer['reason']; ?>&nbsp;</td>
